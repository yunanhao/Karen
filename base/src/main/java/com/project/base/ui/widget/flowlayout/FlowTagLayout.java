package com.project.base.ui.widget.flowlayout;
...
public class FlowTagLayout extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0, childCount = getChildCount(); i < childCount; i++) {
          ...
          //  Log.e("onMeasure: ", realChildWidth + "==" + realChildHeight + "==" + childWidth + "==" + childHeight + "==" +
            //        mlp.leftMargin + "==" + mlp.rightMargin + "==" + mlp.topMargin + "==" + mlp.bottomMargin);
