package com.project.base.ui.widget.shadow;
...
//        }
    ...
    private void ripple(float[] outRadius) {
        ...
        int[][] stateList = new int[][]{new int[]{android.R.attr.state_pressed}, new int[]{android.R.attr.state_focused}, new int[]{android.R.attr.state_activated}, new int[]{}};
    ...
    public void setmBackGround(Drawable drawable, String currentTag) {
        firstView.setTag(android.R.id.home, currentTag);
