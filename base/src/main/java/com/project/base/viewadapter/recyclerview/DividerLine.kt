package com.project.base.viewadapter.recyclerview
...
import com.project.base.util.common.SizeUtils.dp2px
...
class DividerLine(context: Context) : ItemDecoration() {
    ...
    private fun drawVertical(
        ...
        for (i in 0 until childCount) {
            ...
            val right =
                    if (mDividerSize == 0) left + (dp2px(DEFAULT_DIVIDER_SIZE.toFloat()) as Int) else left + mDividerSize
    ...
    private fun drawHorizontal(
        ...
        for (i in 0 until childCount) {
            ...
            val bottom =
                    if (mDividerSize == 0) top + (dp2px(DEFAULT_DIVIDER_SIZE.toFloat()) as Int) else top + mDividerSize
            mDividerDrawable!!.setBounds(left, top, right, bottom)
            //画上去
            mDividerDrawable.draw(c)
        }
